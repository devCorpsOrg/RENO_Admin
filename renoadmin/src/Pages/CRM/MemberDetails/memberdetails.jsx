      ...
      >
        ...
        >
          ...
          <div>
            <div
              className="text-gray-500"
              style={{ marginLeft: "20px", fontSize: "13px", marginTop:"-137px" }}
            >
              Purchased Items
            </div>
            <div
        ...
        >
          ...
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae ea aliquid dignissimos, non autem repudiandae pariatur enim porro possimus consectetur dolore, molestias vel dolorem incidunt deserunt? Accusamus explicabo labore nihil.
          </div>
      ...
      <div className="ml-72" style={{ marginTop: "100px", zIndex:-1 }}>
        ...
        <div className="grid grid-cols-4 gap-6" >
          ...
          >
            ...
            <div
              style={{ marginLeft: "5px", marginTop: "10px", fontSize: "14px" }}
            >
